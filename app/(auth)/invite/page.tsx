      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <div>
              <a className="btn text-white bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://discord.com/oauth2/authorize?client_id=1040206071417012234&permissions=8&scope=bot">리다이렉트 되지 않을시 클릭하세요</a>
            </div>
          </div>
