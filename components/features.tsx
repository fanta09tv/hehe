          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">발로란트 일일상점 확인하기</div>
                    <div className="text-gray-600">귀찮게 컴퓨터에서 오랫동안 발로란트를 켜지 말고,<br></br>디스코드에 접속해 발로봇에서 편하게 명령어 하나로ﾠﾠﾠﾠ<br></br>여러분의 일일 상점을 손쉽게 확인하세요!</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">발로란트 경쟁전 프로필 확인하기</div>
                    <div className="text-gray-600">여러분의 경쟁전 실력을 다른 사용자들과 공유해보세요!ﾠ<br></br>여러분의 경쟁전 티어와 MMR까지 모든 것들을<br></br>한번에 다 편리하게 확인할 수 있어요!</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
